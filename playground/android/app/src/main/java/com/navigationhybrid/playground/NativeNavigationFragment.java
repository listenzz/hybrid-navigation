...
//                getNavigator().push("NativeNavigation");
//            }
//        });
//
...
//            @Override
//            public void onClick(View view) {
//                getNavigator().push("ReactNavigation");
//            }
//        });
//
...
//            @Override
//            public void onClick(View view) {
//                getNavigator().replace("ReactNavigation");
//            }
//        });
//
...
//            @Override
//            public void onClick(View view) {
//                getNavigator().present("NativeResult", REQUEST_CODE);
//            }
//        });
//
...
//                getNavigator().present("ReactResult", REQUEST_CODE, new Bundle(), options, true);
//            }
//        });
//
...
//
//        if (getView() != null) {
//            getView().findViewById(R.id.pop_to_root).setEnabled(!getNavigator().isRoot());
//        }
//
//    }
//
