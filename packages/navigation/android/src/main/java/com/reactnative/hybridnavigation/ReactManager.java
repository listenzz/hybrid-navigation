...
public class ReactManager {
	...
	private final static ReactManager instance = new ReactManager();
	...
	public void install(@NonNull ReactHost reactNativeHost) {
		this.setReactHost(reactNativeHost);
		this.initialize();
	}

	public void setReactHost(@NonNull ReactHost reactHost) {
	...
	private void checkReactHost() {
		if (reactHost == null) {
			throw new IllegalStateException("Must call ReactManager#install first");
		}
	}
	...
	public void startRegisterReactModule() {
		FLog.i(TAG, "ReactManager#startRegisterReactModule");
		reactModules.clear();
	...
	public void endRegisterReactModule() {
		...
		FLog.i(TAG, "ReactManager#endRegisterReactModule");
	...
	private void invokeReloadListeners() {
		for (ReactManager.ReactBridgeReloadListener listener : reactBridgeReloadListeners) {
			listener.onReload();
		}
	}
